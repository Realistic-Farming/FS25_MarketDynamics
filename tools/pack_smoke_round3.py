#!/usr/bin/env python3
"""Pack smoke for the deployed My Games zip (round 3 Esc chrome, 2026-08-05).

Checks: testzip clean; every modDesc sourceFile present; entry count; version 1.2.2.11;
...
check("version 1.2.2.11", version == "1.2.2.11")
