#!/usr/bin/env bash
# ============================================================
# build.sh — Build & deploy FS25_MarketDynamics
# Usage:
...
EXCLUDE_PATHS = {"xml/MDMEventConfig_example.xml"}
...
echo ""
echo "  Done. Check log.txt for [MDM] entries after launching."
echo "============================================"
